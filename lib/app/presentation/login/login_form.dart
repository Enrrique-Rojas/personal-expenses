...
import 'package:personal_expenses/app/common/widget/custom_text_field.dart';
...
import 'package:personal_expenses/app/presentation/login/widget/biometric_login_button.dart';
...
class LoginForm extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    ref.listen<AuthState>(authNotifierPod, (previous, next) {
      next.whenOrNull(
        failure: (message) => Toast.showToast(context, message, Colors.red),
        authenticated: () {
          Toast.showToast(context, '¡Bienvenido de nuevo!', Colors.green);
          context.router.navigate(const ExpensesListRoute());
        },
      );
    });
